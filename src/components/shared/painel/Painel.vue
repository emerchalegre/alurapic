<!-- 
  v-show -> Diretiva para esconde ou mostrar o componente. Semelhante a display: none / block
  v-on -> Diretiva para setar valor a uma variavel. Igual a @
  {{}} -> conhecido como interpolação. Recebe o valor de uma váriavel definida
