    ...
    <div>
        ...
        <form @submit.prevent="gravar()">
            ...
            <div class="controle">
                ...
                <textarea data-vv-as="descrição" name="descricao" v-validate data-vv-rules="min:3|max:30" id="descricao" autocomplete="off" v-model="foto.descricao"></textarea>
                    ...
                    if(success) {
                        this.service
                            ...
                            .then(() => {
                                ...
                                this.foto = new Foto();
                            }, err => this.mensagem = 'Não foi possível gravar a foto' );
                    }
                });
        }
    },
